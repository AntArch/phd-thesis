...
class RasterizeFeatures():
    def __init__(self, 
        ...
        outname = os.path.join(output_directory,'mask.tif')        
        ...
        for arc_pixel in self.arc_indices:
            ...
            if arc.shape[0] > 3:
                if bac.shape[0] > 3:
                    ...
                    print('tshape,',t_arc_bac[0].shape)
                    
                    print('pshape',t_arc_bac[0].shape)
...
if __name__ == "__main__": 
    ...
    root_path = '/home/dav/data/temp/test/done/subsets'
    ...
    for directory in os.listdir(root_path):
       ...
       for survdir in os.listdir(dir_path):
           surveys = os.path.join(dir_path, survdir)
           ...
           if os.path.isdir(folder):
                ...
                print(shp_dir)
                outdir = os.path.join(folder, 'grid_output')
                print(outdir)
